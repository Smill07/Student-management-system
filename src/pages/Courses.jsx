...
const Courses = ({ courses, students, onChanged }) => {
  ...
  return <div className="px-16 pt-5"><Courseswelcome showform={showform} setShowform={setShowform} addCourse={addCourse} />{error && <p className="mt-3 text-sm text-red-700">{error}</p>}<Coursestableheader /><Coursestablerow courses={courses} students={students} deleteCourse={deleteCourse} /></div>
}
